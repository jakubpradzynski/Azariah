...
Vector3 Triangle::fillNormalVectorInPoints()
{
    p1.normalVector = normalizeVector(calculateVectorForPoint(1, *this));
    p2.normalVector = normalizeVector(calculateVectorForPoint(2, *this));
    p3.normalVector = normalizeVector(calculateVectorForPoint(3, *this));
}
