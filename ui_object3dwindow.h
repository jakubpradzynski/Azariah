...
public:
    ...
    QCheckBox *texturing3DObjectCheckBox;
    ...
    void setupUi(QWidget *Object3DWindow)
    {
        ...
        secondLightYSlider->setGeometry(QRect(1540, 290, 291, 22));
        ...
        secondLightZSlider->setGeometry(QRect(1540, 330, 291, 22));
        ...
        secondLightXSlider->setGeometry(QRect(1540, 250, 291, 22));
        ...
        secondLightCheckBox->setGeometry(QRect(1710, 200, 111, 41));
        ...
        texturing3DObjectCheckBox = new QCheckBox(Object3DWindow);
        texturing3DObjectCheckBox->setObjectName(QStringLiteral("texturing3DObjectCheckBox"));
        texturing3DObjectCheckBox->setGeometry(QRect(1540, 380, 291, 41));
        texturing3DObjectCheckBox->setStyleSheet(QStringLiteral("font: 14pt \"MS Shell Dlg 2\";"));
        texturing3DObjectCheckBox->setChecked(false);
        ...
        secondLightZLabel->setGeometry(QRect(1840, 320, 51, 31));
        ...
        secondLightLabel->setGeometry(QRect(1540, 200, 131, 31));
        ...
        secondLightYLabel->setGeometry(QRect(1840, 280, 51, 31));
        ...
        secondLightXLabel->setGeometry(QRect(1840, 240, 51, 31));
    ...
    void retranslateUi(QWidget *Object3DWindow)
    {
        ...
        texturing3DObjectCheckBox->setText(QApplication::translate("Object3DWindow", "Teksturowanie obiektu", nullptr));
